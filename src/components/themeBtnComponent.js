let themebtn = () => 
`
<svg class="fill-primary" xmlns="http://www.w3.org/2000/svg" height="20" viewBox="0 -960 960 960"
    width="20">
    <path id="sun" class="hidden"
...
window.addEventListener("themebtn", function(event) {

    let thisComponent = document.getElementById(event.detail.id)
    thisComponent.classList.add('fixed', 'right-0', 'top-0', 'p-xl');
    ...
    function reflectPreference() {
        ...
        thisComponent.setAttribute("aria-label", themeValue)
